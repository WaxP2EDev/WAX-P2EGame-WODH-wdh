 ...
 */
CONTRACT  drhemstokenx : public contract
{
public:
   using contract::contract;

   drhemstokenx(name receiver, name code, datastream<const char *> ds);
   /**
   ...
   using create_action = eosio::action_wrapper<"create"_n, &drhemstokenx::create>;
   using issue_action = eosio::action_wrapper<"issue"_n, &drhemstokenx::issue>;
   using retire_action = eosio::action_wrapper<"retire"_n, &drhemstokenx::retire>;
   using transfer_action = eosio::action_wrapper<"transfer"_n, &drhemstokenx::transfer>;
   using open_action = eosio::action_wrapper<"open"_n, &drhemstokenx::open>;
   using close_action = eosio::action_wrapper<"close"_n, &drhemstokenx::close>;
